...
export default function Sidebar({ profile, isGuest }: SidebarProps) {
  ...
  return (
    <aside className="w-60 shrink-0 flex flex-col border-r border-zinc-200 bg-white h-screen sticky top-0">
      ...
      <div className="px-3 py-4 border-t border-zinc-100 space-y-1">
        {isGuest ? (
          /* Guest banner */
          <div className="px-3 py-3 rounded-lg bg-zinc-50 border border-zinc-200">
            <p className="text-xs text-zinc-500 mb-2">You&apos;re browsing as a guest.</p>
            <Link
              href="/login"
